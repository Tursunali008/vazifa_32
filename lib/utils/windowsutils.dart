            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  ...
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, fontStyle: FontStyle.normal),
                  textAlign: TextAlign.center,
                ),
                10.height(),
                const Padding(
            ...
            child: Column(
              children: [
                const Text(
                  ...
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.w400, color: Color(0xffF9B800)),
                  textAlign: TextAlign.center,
                ),
                20.height(),
                const Text(
                ...
                Container(
                  ...
                  child: const Row(
                    ...
                    children: <Widget>[
                      Text(
                        "Lorem Ipsum",
                        style: TextStyle(color: Color(0xff262626), fontSize: 18, fontWeight: FontWeight.bold),
                      ),
                      Icon(
                        Icons.arrow_right_alt_rounded,
                        size: 30,
...
class EndContainerWindows extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: const Color(0xff262626)),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: <Widget>[
          const Column(
